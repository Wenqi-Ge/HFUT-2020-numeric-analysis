...
def main():
    ...
    print(formatChange(4.5).ljust(10) + formatChange(func(4.5)).ljust(12)+ formatChange(l45).ljust(14) + formatChange(f45).ljust(12) + formatChange(calErr(l05,4.5)).ljust(15) + formatChange(calErr(f45,0.5)).ljust(12)  )
